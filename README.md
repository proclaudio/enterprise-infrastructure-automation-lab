...
The lab simulates how organizations automate Linux infrastructure using **GitOps workflows, configuration management, and dynamic inventory**.
...
This diagram represents the **automation platform architecture** used in this lab environment.
...
```mermaid
flowchart TD
    A[Developer Push] --> B[GitHub / GitLab Repository]
...
DevOps Infrastructure Automation Lab Project
